package com.example.materialcomponent_jetpackcompose
...
import com.example.materialcomponent_jetpackcompose.ui.theme.MaterialComponentjetPackComposeTheme
import com.example.materialcomponent_jetpackcompose.ui.theme.Purple500

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            MaterialComponentjetPackComposeTheme {
                MaterialComponent()
            }
        }
    }
...
fun MaterialComponent() {
    ...
    Column(
        ...
        TextField(
            ...
            label = { Text(text = "Enter Name", color = Black) },
            modifier = Modifier
                .fillMaxWidth()
                .background(Color.White),
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Enter Password", color = Black) },
            trailingIcon = {
                IconButton(
                    onClick = {
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Comment", color = Black) },
            modifier = Modifier
                .fillMaxWidth()
                .height(100.dp),
            maxLines = 5,
